...
namespace Api3.Migrations
{
    ...
    [Migration("20250620144650_numberpokedex")]
    partial class numberpokedex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api3.Models.ColeccionPokemon", b =>
                {
                    ...
                    b.Property<int>("NumeroAlbum")
                        .HasColumnType("int");

                    b.Property<int>("PokemonIdOriginal")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api3.Models.ProductoPokemon", b =>
                {
                    ...
                    b.Property<string>("UltimoDueno")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("fechaInicioSubasta")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Puja2", b =>
                {
                    b.HasOne("api3.Models.ProductoPokemon", "ProductoPokemon")
                        .WithMany("HistorialPujas")
                        .HasForeignKey("PokemonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductoPokemon");
                });
